...
def lista_platos(request):
    ...
    return render(request, 'gestion/lista_platos.html', {'platos': platos})

def lista_ordenes(request):

    ordenes=Orden.objects.all()
    return render(request, 'gestion/lista_ordenes.html', {'ordenes': ordenes})

def lista_facturas(request):

    facturas=Factura.objects.all()
    return render(request, 'gestion/lista_facturas.html', {'facturas': facturas})